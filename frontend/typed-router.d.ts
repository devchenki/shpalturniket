...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'ping-analytics': RouteRecordInfo<'ping-analytics', '/ping-analytics', Record<never, never>, Record<never, never>>,
    'ping-dashboard': RouteRecordInfo<'ping-dashboard', '/ping-dashboard', Record<never, never>, Record<never, never>>,
    'ping-devices': RouteRecordInfo<'ping-devices', '/ping-devices', Record<never, never>, Record<never, never>>,
    'ping-events': RouteRecordInfo<'ping-events', '/ping-events', Record<never, never>, Record<never, never>>,
    'ping-settings': RouteRecordInfo<'ping-settings', '/ping-settings', Record<never, never>, Record<never, never>>,
    'ping-telegram': RouteRecordInfo<'ping-telegram', '/ping-telegram', Record<never, never>, Record<never, never>>,
